...
def main():
    ...
    print(f"\n>>> 开始 {num_gradients} 梯度 SVR 训练，每个梯度对 {n_properties} 个性能指标分别进行贝叶斯优化...\n")
    ...
    for i in range(1, num_gradients + 1):
        ...
        for prop_idx in range(n_properties):
            ...
            print(f"    - 最优 C: {best_C:.4g}, Gamma: {best_gamma:.4g}, Epsilon: {best_epsilon:.4g}")
    ...
    print(f">>> 全部跑完！SVR的结果已保存至 {OUT_CSV}")
